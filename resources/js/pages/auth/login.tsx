                    ...
                    <div className="animate-in fade-in slide-in-from-bottom duration-600">
                        <Card className="border-0 shadow-2xl bg-card/50 backdrop-blur-sm">
                            ...
                            <CardContent className="space-y-6">
                                ...
                                {status && (
                                    <div className="p-3 text-center text-sm font-medium text-green-600 bg-green-50 dark:bg-green-900/20 rounded-lg">
                                        {status}
                                    </div>
                                )}
                                ...
                                <Form method="post" action={route('login')} resetOnSuccess={['password']} className="space-y-4">
                                    {({ processing, errors }) => (
                                        <>
                                            ...
                                            <Button type="submit" className="w-full h-11" tabIndex={4} disabled={processing}>
